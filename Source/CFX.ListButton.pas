...
uses
  ...
  Vcl.Graphics, Windows, CFX.ThemeManager, CFX.Colors, CFX.Classes,
  CFX.Graphics, CFX.Utilities;
...
type
  ...
  FXListButton = class(TPanel, FXControl)
    private
      ...
      FIconFont: TFont;
      FCustomBackColor: FXColorStateSet;
      ...
      //  Setters
      procedure SetButtonState(const Value: FXControlState);
      procedure SetListStyle(const Value: FXListStyle);
      procedure SetImageKind(const Value: FXPImageKind);
    ...
    published
      ...
      property CustomBackColor: FXColorStateSet read FCustomBackColor write FCustomBackColor;
      property ButtonState: FXControlState read FButtonState write SetButtonState default csNone;
      property ListStyle: FXListStyle read FListStyle write SetListStyle default lsRightDetail;
      property ImageKind: FXPImageKind read FImageKind write SetImageKind default ikFontIcon;
...
var
  _BackColor: FXColorStateSet;
  AccentColor: TColor;
  IsSelected: Boolean;
  IsDark: Boolean;
begin
  IsDark := ThemeManager.DarkTheme;
  ...
  //  Enabled
    ...
    begin
      ...
      //  Selected
      if IsSelected then
        BackColor := ChangeColorLight(AccentColor, _BackColor.GetColor(ThemeManager.DarkTheme, ButtonState, IsSelected))
          //  Transparent
            ...
            begin
              ...
              //  Not selected
                ...
                BackColor := _BackColor.GetColor(ThemeManager.DarkTheme, ButtonState, IsSelected);
...
//  SETTERS
procedure FXListButton.SetButtonState(const Value: FXControlState);
begin
...
procedure FXListButton.SetImageKind(const Value: FXPImageKind);
begin
...
begin
  ...
  IconFont.Size := 12;
  FCustomBackColor := FXColorStateSet.Create;
