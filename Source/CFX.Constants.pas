...
const
  ...
  TABSTRIP_TAB_ITEM_DEFAULT_SIZE = 175;
  TABSTRIP_TAB_ITEM_ROUND = 12;
  TABSTRIP_TAB_LINE_WIDTH = 1;
  TABSTRIP_TAB_TEXT_BLEND_FADE = 100;
  TABSTRIP_TAB_TEXT_DOWN_BLEND_FADE = 150;
  TABSTRIP_TAB_ICON_SPACING = 5;
  TABSTRIP_TAB_IMAGE_SCALE = 1.1;

  TABSTRIP_BUTTON_SIZE = 40;
  TABSTRIP_BUTTON_SPACING = 10;
  TABSTRIP_PADDING_START = 15;
