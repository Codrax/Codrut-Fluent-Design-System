...
begin
  inherited;
  BackColor := ThemeManager.ToolTip.LightBackGround;
  BorderColor := ThemeManager.ToolTip.LightBackGroundInterior;
end;
{ FXDarkTooltip }
constructor FXDarkTooltip.Create(aOwner: TComponent);
begin
  inherited;
  BackColor := ThemeManager.ToolTip.DarkBackGround;
  BorderColor := ThemeManager.ToolTip.DarkBackGroundInterior;
end;
{ FXCustomTooltip }
//  MAIN CLASS
